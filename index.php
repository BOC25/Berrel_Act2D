                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=$row['year_level'];?></td>
                             <td><a href='edit.php?id=5' class='btn btn-sm btn-warning'>Edit</a>
                            <a href='delete.php?id=5' class='btn btn-sm btn-danger' onclick="return confirm('Are you sure you want to delete this student?');">Delete</a></td>
